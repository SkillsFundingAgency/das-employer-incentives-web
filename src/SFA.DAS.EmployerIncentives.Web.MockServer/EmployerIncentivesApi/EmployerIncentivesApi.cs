    ...
    public class EmployerIncentivesApiBuilder
    {
        ...
        public EmployerIncentivesApiBuilder WithAccountWithSingleLegalEntityWithNoEligibleApprenticeships()
        {
            ...
            Response.Create()
                ...
                .WithBody(JsonSerializer.Serialize(new List<LegalEntityDto>() { data.LegalEntity }, TestHelper.DefaultSerialiserSettings)));
            ...
            _server
                ...
                .RespondWith(
                    Response.Create()
                        .WithStatusCode(HttpStatusCode.OK)
                        .WithBody(JsonSerializer.Serialize(data.LegalEntity, TestHelper.DefaultSerialiserSettings)));
        ...
        public EmployerIncentivesApiBuilder WithSingleLegalEntityWithEligibleApprenticeships()
        {
            ...
            Response.Create()
                .WithStatusCode(HttpStatusCode.OK)
                .WithBody(JsonSerializer.Serialize(data.LegalEntities, TestHelper.DefaultSerialiserSettings)));
            ...
            _server
              .Given(
                  ...
                  .RespondWith(
              Response.Create()
                  .WithBody(JsonSerializer.Serialize(data.Apprentices, TestHelper.DefaultSerialiserSettings))
                  .WithStatusCode(HttpStatusCode.OK));           
        ...
        public EmployerIncentivesApiBuilder WithMultipleLegalEntities()
        {
            ...
            _server
                ...
                .RespondWith(
                    Response.Create()
                        .WithStatusCode(HttpStatusCode.OK)
                        .WithBody(JsonSerializer.Serialize(data.LegalEntity1, TestHelper.DefaultSerialiserSettings)));
            ...
            _server
                ...
                .RespondWith(
                    Response.Create()
                        .WithStatusCode(HttpStatusCode.OK)
                        .WithBody(JsonSerializer.Serialize(data.LegalEntity2, TestHelper.DefaultSerialiserSettings)));
            ...
            _server
                ...
                .RespondWith(
                    Response.Create()
                        .WithStatusCode(HttpStatusCode.OK)
                        .WithBody(JsonSerializer.Serialize(data.LegalEntity3, TestHelper.DefaultSerialiserSettings)));
        ...
        public EmployerIncentivesApiBuilder WithPreviousApplications()
        {
            ...
            var getApplicationsResponse = new GetApplicationsModel { ApprenticeApplications = applications, FirstSubmittedApplicationId = Guid.NewGuid(), BankDetailsStatus = BankDetailsStatus.NotSupplied };
            _server
                .Given(
                    Request
                        .Create()
                ...
                .RespondWith(
                    Response.Create()
                        .WithStatusCode(HttpStatusCode.OK)
                        .WithBody(JsonSerializer.Serialize(getApplicationsResponse)));
        ...
        public EmployerIncentivesApiBuilder WithPreviousApprenticeshipIncentives()
        {
            ...
            _server
                ...
                .RespondWith(
                    Response.Create()
                        .WithStatusCode(HttpStatusCode.OK)
                        .WithBody(JsonSerializer.Serialize(applications)));
        ...
        public EmployerIncentivesApiBuilder WithoutASignedAgreement()
        {
            ...
            _server
                ...
                .RespondWith(
                    Response.Create()
                        .WithStatusCode(HttpStatusCode.OK)
                        .WithBody(JsonSerializer.Serialize(data.LegalEntities.First(), TestHelper.DefaultSerialiserSettings)));
        ...
        public EmployerIncentivesApiBuilder WithBankingDetails()
        {
            ...
            _server
                ...
                .RespondWith(
                    Response.Create()
                        .WithBody(JsonSerializer.Serialize(data.BankingDetails, TestHelper.DefaultSerialiserSettings))
                        .WithStatusCode(HttpStatusCode.OK));
        ...
        public EmployerIncentivesApiBuilder WithApplicationWithAllInEligibleEmployerStartDates()
        {
            ...
            _server
                ...
                .RespondWith(
                    Response.Create()
                        .WithBody(JsonSerializer.Serialize(data.AccountLegalEntityId1))
                        .WithStatusCode(HttpStatusCode.OK));
            ...
            _server
                ...
                .RespondWith(
                    Response.Create()
                        .WithBody(JsonSerializer.Serialize(data.ApplicationResponse))
                        .WithStatusCode(HttpStatusCode.OK));
        ...
        public EmployerIncentivesApiBuilder WithUpdateVrfCaseStatus()
        {
            var data = new TestData.Account.WithMultipleLegalEntitiesWithEligibleApprenticeships();
            _server
                .Given(
                    Request
                        .Create()
                        .WithPath(x => x.Contains($"accounts/{data.AccountId}/legalentity/{data.AccountLegalEntityId1}/vrfcasestatus"))
                        .UsingPut()
                )
                .RespondWith(
                    Response.Create()
