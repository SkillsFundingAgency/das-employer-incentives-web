...
namespace SFA.DAS.EmployerIncentives.Web.MockServer.EmployerIncentivesApi
{
    public class EmployerIncentivesApiBuilder
    {
        ...
        public EmployerIncentivesApiBuilder WithPreviousApplications()
        {
            ...
            var getApplicationsResponse = new GetApplicationsModel { ApprenticeApplications = applications, BankDetailsStatus = BankDetailsStatus.NotSupplied, FirstSubmittedApplicationId = Guid.NewGuid() };
            _server
                .Given(
                    Request
                        .Create()
