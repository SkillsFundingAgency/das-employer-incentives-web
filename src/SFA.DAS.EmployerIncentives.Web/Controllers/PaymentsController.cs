    ...
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> ListPaymentsForLegalEntity(string accountId, string accountLegalEntityId, string sortOrder, string sortField)
        {
            ...
            var model = new ViewApplicationsViewModel
            {
                ...
                SortField = sortField,
                ShowBankDetailsCalltoAction = getApplicationsResponse.BankDetailsStatus == BankDetailsStatus.NotSupplied || getApplicationsResponse.BankDetailsStatus == BankDetailsStatus.Rejected,
