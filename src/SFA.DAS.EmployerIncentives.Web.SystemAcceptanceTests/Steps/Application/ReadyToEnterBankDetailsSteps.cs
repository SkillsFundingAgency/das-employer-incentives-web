    ...
    public class ReadyToEnterBankDetailsSteps : StepsBase
    {
            ...
            _testContext.EmployerIncentivesApi.MockServer
                ...
                .RespondWith(
                    Response.Create()
                        .WithStatusCode(HttpStatusCode.OK)
                        .WithHeader("Content-Type", "application/json")
                        .WithBody(JsonSerializer.Serialize(_data.LegalEntity)));
        ...
        public async Task WhenTheEmployerConfirmsTheyCanProvideTheirBankDetails()
        {
            ...
            _testContext.EmployerIncentivesApi.MockServer
                ...
                .RespondWith(
                    Response.Create()
                        .WithBody(JsonSerializer.Serialize(_data.BankingDetails, TestHelper.DefaultSerialiserSettings))
                        .WithStatusCode(HttpStatusCode.OK));
        ...
        public async Task WhenTheEmployerStatesThatTheyAreUnableToProvideBankDetailsNow()
        {
            ...
            _testContext.EmployerIncentivesApi.MockServer
                ...
                .RespondWith(
                    Response.Create()
                        .WithStatusCode(HttpStatusCode.OK)
                        .WithBody(JsonSerializer.Serialize(_data.LegalEntity, TestHelper.DefaultSerialiserSettings)));
