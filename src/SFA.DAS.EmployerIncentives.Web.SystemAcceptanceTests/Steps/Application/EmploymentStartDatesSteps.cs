...
namespace SFA.DAS.EmployerIncentives.Web.SystemAcceptanceTests.Steps.Application
{
    ...
    public class EmploymentStartDatesSteps : StepsBase
    {
        ...
        {
            var apprenticeships = _data.Apprentices.Apprenticeships.ToApprenticeshipModel(_hashingService).ToArray();
            var url = $"{_data.HashedAccountId}/apply/{_data.HashedAccountLegalEntityId}/complete-apprentices";
