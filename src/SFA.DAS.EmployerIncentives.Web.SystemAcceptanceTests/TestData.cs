    ...
    public static class TestData
    {
        ...
        public static class Account
        {
            ...
            public class WithSingleLegalEntityWithEligibleApprenticeships
            {
                ...
                public ApprenticeDto Apprentice1 => new ApprenticeDto
                {
                    ApprenticeshipId = 1,
                ...
                public ApprenticeDto Apprentice2 => new ApprenticeDto
                {
                    ApprenticeshipId = 2,
                    CourseName = "T&D ...",
                    LastName = "Leeman",
                ...
                public ApprenticeDto Apprentice3 => new ApprenticeDto
                {
                    ApprenticeshipId = 3,
