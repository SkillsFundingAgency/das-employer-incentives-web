...
{
    [TestFixture]
    public class WhenNoLegalEntitySelected
    {
        ...
        [Test]
        public async Task Then_the_choose_organisation_error_page_is_displayed_for_the_account()
        {
            // Arrange
            ...
            // Act
            var result = await _sut.ChooseOrganisation(_viewModel) as ViewResult;
